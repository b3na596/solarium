...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Solarium Launched";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1520685352, vin, vout, 0);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1520685352;
        genesis.nBits = 520159231; // bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 51407;
		
        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x0000378085cf4776478fcfa36d12dbd4850c71020c088c9b6b8013bac97d9a15"));
        assert(genesis.hashMerkleRoot == uint256("0xc3c703d2a05853160ffcd74686ee7b86840bb21fe0956901cdafa6546ac40d2a"));
        ...
        base58Prefixes[EXT_SECRET_KEY] = list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
                ...
                vSeeds.push_back(CDNSSeedData("0", "node1.solariumcoin.com"));
                vSeeds.push_back(CDNSSeedData("1", "node2.solariumcoin.com"));
		vSeeds.push_back(CDNSSeedData("2", "node3.solariumcoin.com"));
		vSeeds.push_back(CDNSSeedData("3", "node4.solariumcoin.com"));
		vSeeds.push_back(CDNSSeedData("4", "node5.solariumcoin.com"));
		vSeeds.push_back(CDNSSeedData("5", "node6.solariumcoin.com"));
		vSeeds.push_back(CDNSSeedData("6", "node7.solariumcoin.com"));
